...
APP_DESC = """
Python Simple Executable Testing Tool
...
def cli_parse(args):
    ...
    if args.output in ['json', 'j']:
        print(dump_json(p_def.d_serialize()))
    else:
...
def make_cli_parser() -> argparse.ArgumentParser:
    def _shared_options(sub):
        ...
        sub.add_argument('-P', '--project', type=str,
                         help='Location or name of the project definition file')
        sub.add_argument('-S', '--suite', type=str,
                         help='Location or name of the suite definition file')
        sub.add_argument('-T', '--tests', type=str, help='Location of the df files',
                         default='./tests')
        sub.add_argument('-D', '--data', type=str,
